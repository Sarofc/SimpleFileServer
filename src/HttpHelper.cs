...
namespace Saro.FileServer
{
    ...
    {
        public static void UploadFiles(string url, IList<string> filePaths, IList<string> fileNames, Action<string, int, int> onProgress = null)
        {
            ...
            using (var requestStream = request.GetRequestStream())
            {
                ...
                for (int i = 0; i < filePaths.Count; i++)
                {
                    ...
                    onProgress?.Invoke(filePath, i, filePaths.Count);
